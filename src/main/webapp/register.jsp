			...
			<table class="text-white bg-black">
				...
				<tr>
					<td colspan="2"><label for="email">E-mail</label> <br> <input
						id="email" name="email" type="email" size="50"> <br>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td><label for="password">Password</label> <br> <input
						id="password" name="password" type="password"> <br> <br>
					</td>
					<td><label for="phoneNo">Phone Number</label> <br> <input
						id="phoneNo" name="phoneNo" type="text"> <br> <br>
					</td>
				</tr>
				<tr>
					<td colspan="2">
